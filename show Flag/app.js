...
countryListAllIsoData.forEach(function(country) {
...
// Function to display details of the selected country
function displayCountryDetails() {
    var countryCode = countryDropdown.value;
    var selectedCountry = countryListAllIsoData.find(function(country) {
        return country.code.toLowerCase() == countryCode;
    });
    ...
    if (selectedCountry) {
		...
		var NcodeRow = document.createElement('tr');

        var nameCell = document.createElement('td');
        var codeCell = document.createElement('td');
		var NcodeCell = document.createElement('td');

        nameCell.textContent = "Country's Official Name: " + selectedCountry.name;
        codeCell.textContent = "Country 2-character Code: " + selectedCountry.code;
		NcodeCell.textContent = "Country Numeric Code: " + selectedCountry.number;

        nameRow.appendChild(nameCell);
        codeRow.appendChild(codeCell);
		NcodeRow.appendChild(NcodeCell);

        countryDetails.appendChild(nameRow);
        countryDetails.appendChild(codeRow);
		countryDetails.appendChild(NcodeRow);
    }
...
countryDropdown.addEventListener('change', displayCountryDetails);

// Function to display the flag based on selected country
function displayFlag() {
    var countryCode = countryDropdown.value;
    var flagDiv = document.getElementById('flag-icons');
    flagDiv.className = "fi fi-" + countryCode;
}
